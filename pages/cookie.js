        ...
        <div className="flex flex-wrap w-full mb-20">
          <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
            ...
            <p className="md:text-lg text-base mt-4">
              ...
              to citizens and permanent residents of the European Economic Area
              and Switzerland.
            </p>
          </div>
        </div>
          ...
          <div className="w-full p-4">
            ...
            <div className="w-full">
              ...
              <p className="leading-relaxed text-lg mb-4">
                ...
                third parties commissioned by us. In the document below we
              ...
              <p className="leading-relaxed mb-4">
                ...
                sent to our servers or the servers of relevant third parties
              ...
              <p className="leading-relaxed mb-4">
                ...
                way, you don't have to enter the same information repeatedly
                when you visit our website or, for example, your items remain in
                your shopping cart until you pay. We may place these cookies
              ...
              <p className="leading-relaxed mb-4">
                ...
                cookies you as a website visitor are linked to a unique ID.
                However, these cookies do not create a profile of your behavior
                and interests to serve personalized ads.
              </p>
              <p className="leading-relaxed text-lg mb-4">
              ...
              <p className="leading-relaxed mb-4">
                ...
                such as Facebook, Twitter, LinkedIn, Instagram and Pinterest.
                This content is embedded with code from Facebook, Twitter,
                LinkedIn, Instagram and Pinterest that places cookies. This
                content may store and process certain information for
                personalized advertising. Please read the privacy policy of
                these social networks (which may change regularly) to find out
                how they handle your (personal) data that they process using
                these cookies. The data retrieved is anonymized as much as
                possible. Facebook, Twitter, LinkedIn, Instagram and Pinterest
              ...
              <p className="leading-relaxed text-lg mb-4">
                ...
                all the categories of cookies and plugins you have chosen as
                described in this cookie statement. You can disable the use of
                cookies via your browser, but please note that if you do this
              ...
              <p className="leading-relaxed text-lg mb-4">
                ...
                internet browser to notify you each time a cookie is placed. For
                more information about these options, see the instructions in
                your browser's Help section. Please note that our website may
                not function properly if all cookies are disabled. If you delete
                the cookies in your browser, they will be placed again when you
              ...
              <nav className="mb-10">
                ...
                <li className="pb-1">
                  ...
                  have the right to withdraw this consent and have your personal
                  data deleted.
                </li>
                <li className="pb-1">
              ...
              <p className="leading-relaxed  mb-4">
                ...
                it, but you also have the right to address it to the supervisory
