            ...
            <div className="flex flex-wrap ">
              <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                <div className="relative lg:max-w-md">
                  ...
                  <div
                    className="absolute bottom-0 right-0 z-10 p-8  border-4 rounded shadow border-blue-400 lg:-mb-8 lg:-mr-11 sm:p-8 :text-gray-300 bg-gray-800 ">
                    <p className="text-lg font-semibold md:w-72">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        className="absolute top-0 left-0 w-10 h-10  text-blue-300 "
                        viewBox="0 0 16 16">
                        <path
