        ...
        <div className=" p-4 min-h-screen">
          <div className="hiddenn max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
            <div className="w-full mt-12 text-gray-100">
              ...
              <h2 className="my-8 text-4xl font-bold text-white md:text-5xl">Our Work</h2>
              <p className="text-gray-300 text-2xl md:text-3xl ">We have built many products and some of them are below</p>
            </div>
            <div
              className="mt-16 grid divide-x divide-y  divide-gray-700 overflow-hidden rounded-tl-[6rem] rounded-br-[6rem] rounded-tr-2xl rounded-bl-2xl  border text-gray-600 border-gray-700 sm:grid-cols-2 lg:grid-cols-4  lg:divide-y-0 xl:grid-cols-4">
              <div className="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl  hover:shadow-gray-600/10">
                <div className="relative space-y-8 py-12 p-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-300 leading-[2rem] text-lg">Platform to convert Domains into Content websites.</p>
                  </div>
                </div>
              </div>
              <div className="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
                <div className="relative space-y-8 py-12 p-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-300 leading-[2rem] text-lg">Platform to create dynamic widgets for websites.</p>
                  </div>
                </div>
              </div>
              <div className="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
                <div className="relative space-y-8 py-12 p-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-300 leading-[2rem] text-lg">API SaaS Platform that provides API Suit to help you ship fast.</p>
                  </div>
                </div>
              </div>
              <div className="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
                <div className="relative space-y-8 py-12 p-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-300 leading-[2rem] text-lg">Chrome Extension that lets you add ChatGPT on any website</p>
                  </div>
                </div>
              </div>
            </div>
