...
const about = () => {
  ...
  return accessToken ? (
    ...
    <>
            ...
            <div className="flex flex-wrap ">
              <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                <div className="relative lg:max-w-md">
                  ...
                  <div
                    className="absolute bottom-0 right-0 z-10 p-8 bg-white border-4 border-blue-500 rounded shadow dark:border-blue-400 lg:-mb-8 lg:-mr-11 sm:p-8 text-gray-800  ">
                    <p className="text-lg text-blue-700 font-semibold md:w-72">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        className="absolute top-0 left-0 w-14 h-14 text-blue-700 dark:text-gray-300 opacity-30"
                        viewBox="0 0 16 16">
                        <path
              ...
              <div className="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 ">
                <div className="pl-4 mb-6 border-l-4 border-blue-500 ">
                  <span className="text-sm  uppercase text-gray-100">Who we are?</span>
                  <h1 className="mt-2 text-3xl font-black  md:text-5xl text-gray-300">
                    About Us
                  </h1>
                </div>
                <p className="mb-6 text-base leading-7text-gray-400">
                ...
                <a href="#"
                  className="px-4 py-2 text-2xl text-gray-100 bg-blue-600 rounded  hover:bg-blue-700">
                  Learn more
                </a>
              </div>
            </div>
      ...
      <div className='hiddenn container justify-center pb-24 items-center text-5xl text-center mx-auto w-full'>
