  ...
  return accessToken ? (
    <>
      ...
      <div className="bg-[#111111] text-white relative overflow-hidden">
        ...
        >
          <video
            className="w-[100vw] bg-[#111111] opacity-80 fixed z-0 top-0 right-0 left-0 object-cover "
            autoPlay
            muted
            playsInline
            loop
        ...
        >
          <div className="justify-center text-white  pb-6 text-center items-center w-full relative mx-auto z-10">
            <h1 className="text-5xl font-bold mb-20 animatable fadeInUp pt-10">
              Benefits{" "}
            </h1>
        ...
        <section className="text-white block relative bg-[#111111] -my-1 ">
          <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center animatable fadeInUp ">
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
              ...
              <p className="mb-10 leading-relaxed w-1/2">
