  ...
  return (
    <>
     <Head>
        ...
        <link rel="canonical" href={`${process.env.NEXT_PUBLIC_BASE_URL}certificates`} />
        ...
        <meta property="og:url" content={`${process.env.NEXT_PUBLIC_BASE_URL}certificates`} />
        {/* Twitter meta tags */}
      ...
      <section className=" body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h1 className="sm:text-4xl text-3xl font-medium title-font mb-2 ">CERTIFICATES / CERTIFICATES</h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base sm:text-lg">Download certificates</p>
          </div>
          <div className="lg:w-3/4 w-full mx-auto overflow-auto">
            <table className="table-auto w-full text-left ">
              <thead>
                <tr>
                  <th className="px-4 py-3 title-font tracking-wider font-medium text-sm sm:text-base bg-gray-900 rounded-tl rounded-bl">Certificate / certificate</th>
                  <th className="px-4 py-3 title-font tracking-wider font-medium text-sm sm:text-base bg-gray-900">Description / Location / Cert No.</th>
                  <th className="px-4 py-3 title-font tracking-wider font-medium text-sm sm:text-base bg-gray-900">Language</th>
                  <th className="px-4 py-3 title-font tracking-wider font-medium text-sm sm:text-base bg-gray-900">Download</th>
                  <th className=" title-font tracking-wider font-medium text-sm sm:text-base bg-gray-900 rounded-tr rounded-br">Download</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td className="px-4 py-3 text-lg "><Link href="/QM_9001_de.pdf" download="QM/German" aria-label="QM/German">
                ...
                <tr>
                  <td className="border-t-2 border-b-2 border-gray-200 px-4 py-3">ISO 14001:2015</td>
                  <td className="border-t-2 border-b-2 border-gray-200 px-4 py-3">Environmental management system ISO 14001: 2015 Location: Germany 066984 UM15</td>
                  ...
                  <td className="border-t-2 border-b-2 border-gray-200 text-center">
                  </td>
                </tr>
                <tr>
                  <td className="border-t-2 border-b-2 border-gray-200 px-4 py-3">ISO 9001:2015</td>
                ...
                <tr>
                  <td className="border-t-2 border-b-2 border-gray-200 px-4 py-3">ISO 9001:2015 IQNet</td>
                  <td className="border-t-2 border-b-2 border-gray-200 px-4 py-3">International Certification Network Location Slovakia DE-490354 QM15</td>
                  <td className="border-t-2 border-b-2 border-gray-200 px-4 py-3">English</td>
                  <td className="border-t-2 border-b-2 border-gray-200 px-4 py-3 text-lg ">
