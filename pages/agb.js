          ...
          <div className="w-full p-4">
            ...
            <div className="w-full">
              ...
              <p class="leading-relaxed text-lg mb-4">
                ...
                expressly agreed in writing. Without such an express agreement,
                ...
                conditions of business and payment does not affect the validity
                and effectiveness of the rest of the conditions. If individual
                conditions are unavoidable, the contractual partners are obliged
              ...
              <p class="leading-relaxed text-lg mb-4">
                ...
                to the obligations of the contractor. The client ensures that
                all accident prevention and occupational safety regulations
                applicable at the employee's place of employment as well as the
                provisions of the Working Hours Act (ArbZG) are adhered to and
                that first aid facilities and measures are guaranteed. The
                ...
                influences while working in the client's company or carries out
                hazardous activities within the meaning of BGV A 4, the client
                must carry out an occupational medical check-up before starting
                this activity. In the event of an accident at work, the client
                must notify the contractor immediately.
              </p>
              <p className="font-medium mb-4 text-center text-xl sm:text-2xl">
              ...
              <p class="leading-relaxed text-lg mb-4">
                ...
                indirectly from the contractual relationship. Should a provision
                in these terms and conditions or a provision within the
                framework of other agreements be or become invalid, this will
                not affect the effectiveness of all other provisions or
                agreements.
              </p>
