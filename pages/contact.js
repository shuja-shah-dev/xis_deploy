    ...
    return accessToken ? (
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="px-2">
                                    <button
                                       ...
                                       {loading ? <svg aria-hidden="true" className="inline w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <>
            <Head>
                ...
                />
                <meta property="og:title" content="Contact us - AI detection, AI detector, AI robotic, AI web, AI technologies, computer vision, precision recall, robotic inspection." />
                <meta name="viewport" content="width=device-width, initial-scale=1.0" />
            </Head>
