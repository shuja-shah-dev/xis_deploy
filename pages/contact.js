        ...
        <>
            ...
            <div className="justify-center my-12 text-center items-center mx-auto w-100">
                <h1 className="text-4xl md:text-5xl w-full lg:text-[5rem]  text-center mx-auto">
                    Contact <span style={{ fontWeight: "600" }}>24/7.</span>
                </h1>
            </div>
            <section class="flex items-center  font-poppins ">
                <div class="justify-center flex-1 max-w-6xl px-4 py-24 mx-auto md:px-6">
                    <h2 class="pb-2 text-xl font-bold text-center md:text-4xl ">
                        Let's Connect
                    </h2>
                    <div class="w-56 mx-auto mb-6 border-b border-red-700 dark:border-gray-300"></div>
                    <div class="flex flex-wrap px-4 py-8 rounded-md shadow bg-gray-900">
                        <div class="w-full px-4 mb-6 lg:w-2/5 lg:mb-0">
                            <div class="relative h-full p-8 rounded-md bg-gradient-to-r from-blue-900 via-cyan-900 to-sky-900">
                                <div class="absolute bottom-0 right-0 items-center justify-center hidden lg:inline-flex">
