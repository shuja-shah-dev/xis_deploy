          ...
          <div className="w-full p-4">
            ...
            <div className="flex flex-wrap w-full mb-20">
              ...
              <p className="lg:w-1/2 w-full leading-relaxed">
                ...
                Sales Tax Act: DE 242510327{" "}
                <strong className="text-[#57C8E7]">District Court </strong>
                Register court: Mannheim District Court Registration number: HRA
                708898{" "}
                <strong className="text-[#57C8E7]">
                  Responsible for the content in accordance with Section 55
                  Paragraph 2 RStV
                </strong>{" "}
                : Hartmut Schneider XRAY LAB Industrial Services GmbH & Co. KG
                Theodor-Schweitzer-Str. 1+3 75447 Sternenfels
              </p>
            </div>
            <div className="w-full">
              ...
              <p className="sm:text-lg text-base font-medium title-font mb-10">
                ...
                address in our legal notice. We are neither obliged nor willing
                to take part in the dispute resolution process. The images used
                on this website come from, among others , XRAY-LAB, Deutsche
                Messe AG, from Fotolia.com: MH, kimtaro2008, Gesina Ottner from
                iStockphoto.com: M_a_y_a, querbeet, wahahaz, turbohampster,
                Stefan Weichelt, Volodymyr Krasyuk, kyoshino, Harald Richter,
                Givaga, Wavebreakmedia, gordana jovanovic, BostjanT, Edi_Eco,
                MiguelMalo, Kajdi Szabolcs, deepblue4you, choreograph, Bosca78,
                Alengo, gorodenkoff from depositphotos:MasterMariner, from
              ...
              <p className="leading-relaxed text-lg mb-4">
                ...
                10 TMG, as a service provider we are not obliged to monitor
                ...
                remove or block the use of information in accordance with
                ...
                violation. If we become aware of any corresponding legal
                violations, we will immediately remove this content.
              </p>
              <p className="font-medium mb-4 text-center text-xl sm:text-2xl">
                Liability for links
              </p>
              <p className="leading-relaxed text-lg mb-4">
                ...
                apparent at the time of linking. However, permanent control of
              ...
              <p className="leading-relaxed text-lg mb-4">
                ...
                are only permitted for private, non-commercial use. If the
